 ...
 */
class Twig_I18nExtension_TokenParser_Trans extends Twig_TokenParser
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new Twig_I18nExtension_Node_Trans($body, $domain, null, null, $vars, $lineno, $this->getTag());
    }
