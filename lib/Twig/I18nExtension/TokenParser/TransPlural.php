 ...
 */
class Twig_I18nExtension_TokenParser_TransPlural extends Twig_I18nExtension_TokenParser_Trans
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new Twig_I18nExtension_Node_Trans($body, $domain, $plural, $count, $vars, $lineno, $this->getTag());
    }
