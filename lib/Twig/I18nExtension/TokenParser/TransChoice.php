 ...
 */
class Twig_I18nExtension_TokenParser_TransChoice extends Twig_I18nExtension_TokenParser_Trans
{
    /**
    ...
    public function parse(Twig_Token $token)
    {
        ...
        return new Twig_I18nExtension_Node_Trans($body, $domain, null, $count, $vars, $lineno, $this->getTag());
    }
